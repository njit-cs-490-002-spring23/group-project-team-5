...
import { isConversationArea, isONWArea, isViewingArea } from '../types/TypeUtils';
...
import ONWAreaController from './interactable/ONWAreaController';
    ...
    return new Promise<void>((resolve, reject) => {
      ...
      this._socket.on('initialize', initialData => {
        ...
        initialData.interactables.forEach(eachInteractable => {
          ...
          } else if (isONWArea(eachInteractable)) {
            this._interactableControllers.push(
              new ONWAreaController(eachInteractable.id, eachInteractable, this),
            );
          }
        });
