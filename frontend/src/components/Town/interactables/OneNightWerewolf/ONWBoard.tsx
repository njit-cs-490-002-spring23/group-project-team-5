...
export default function ONWBoard({ gameAreaController }: ONWGameProps): JSX.Element {
  ...
  const renderVoteScreen = () => {
    const getVoteText = () => {
      switch (playerRole.role) {
        case 'Villager':
          return `${currentUserUsername}, cast your vote for the player you believe is the Werewolf.`;
        case 'Werewolf':
          return `${currentUserUsername}, defend yourself! Convince others not to vote for you.`;
        case 'Seer':
          return `${currentUserUsername}, participate in the discussion and cast your vote wisely.`;
        default:
          return '';
      }
    };
